...
public class TC005_WrongData {
	...
	@Test(priority=1)
	public void wrongDataFunctionality() throws InterruptedException
	{
		SoftAssert m_assert=new SoftAssert();
		search.wrongData("jimish.shah1990@gmail.com", "Test Subject", "Test Description");
		m_assert.assertAll();
	}
